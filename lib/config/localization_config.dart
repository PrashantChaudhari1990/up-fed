...
class LocaleLanguage{
  ...
  Locale locale;
  LocaleLanguage({required this.language,required this.langInEnglish, this.langShortCode,required this.locale});
}
...
class LocalizationConfig{
  ...
  static final List<LocaleLanguage> supportedLanguages = [
    LocaleLanguage(language: 'English',langInEnglish: 'English',langShortCode: 'Aa',locale: const Locale('en', 'IN')),
    LocaleLanguage(language: 'हिंदी',langInEnglish: 'Hindi', langShortCode: 'आ',locale: const Locale('hi', 'IN')),
    LocaleLanguage(language: 'मराठी',langInEnglish: 'Marathi', langShortCode: 'एम',locale: const Locale('mr', 'IN')),
  ];
