...
class CustomSnackBar{
  ...
  static warning({required BuildContext context,required String message}){
    _showSnackBar(context, Colors.orangeAccent, message,const Duration(seconds: 4));
  }
  static info({required BuildContext context,required String message}){
    _showSnackBar(context, Colors.blueAccent, message,const Duration(seconds: 4));
  }
  ...
  static _showSnackBar(BuildContext context,Color bgColor,String message,Duration snackBarDuration){
  ...
  static _showTopSnackBar(BuildContext context,Color bgColor,String message){
    showTopSnackBar(
     ...
     dismissType: DismissType.onSwipe,
      dismissDirection: [DismissDirection.horizontal,DismissDirection.vertical]
    );
