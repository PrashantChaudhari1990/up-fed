...
import 'package:abcof_ui/themes/styles/typography.dart';
...
ThemeData lightTheme = ThemeData(
  ...
  iconButtonTheme: IconButtonThemeData(
      style: ButtonStyle(
          iconColor: WidgetStateProperty.all(ThemeColors.primaryColor))),
  textTheme:
      const TextTheme(headlineSmall: TextStyle(fontWeight: FontWeight.w500)),
