...
### Project Structure
This is a Flutter mobile application for vendor partners with a hybrid approach using WebView for business logic and native Flutter for authentication and core app functionality.
